// MFP project, ExprAnalyzer.java : Designed and developed by Tony Cui in 2021
...
public class ExprAnalyzer {
    ...
    public static AbstractExpr analyseExpression(String strExpression, CurPos curpos)
        ...
        return analyseExpression(strExpression, curpos, new LinkedList<Variable>(), new ProgContext());
    }
    
    public static AbstractExpr analyseExpression(String strExpression, CurPos curpos, LinkedList<Variable> listPseudoConsts, ProgContext progContext)
            throws JFCALCExpErrException, JSmartMathErrException, InterruptedException    {
        ...
        while (curpos.m_nPos < strExpression.length()) {
            ...
            if (ElemAnalyzer.isBoundOperatorChar(strExpression, curpos.m_nPos)) {
                ...
                if (BOPTRCurboptr.isEqual(OPERATORTYPES.OPERATOR_LEFTPARENTHESE)) {
                    aeCurExpr = analyseExpression(strExpression, curpos, listPseudoConsts, progContext);
            ...
            /* The new cell seems to be a data reference */
                ...
                aeCurExpr = smelemAnalyzer.getDataRefAExpr(strExpression, curpos, listPseudoConsts, progContext);
                if (nLastPushedCellType == 1) {
            ...
            /* a member indicator char */
				...
				aeCurExpr = tsAbstractExpr.poll();
                aeCurExpr = smelemAnalyzer.getExprNameAExpr(aeCurExpr, strExpression, curpos, listPseudoConsts, progContext);
             ...
             */
                ...
                aeCurExpr = smelemAnalyzer.getExprNameAExpr(null, strExpression, curpos, listPseudoConsts, progContext);
                /* A function might return NULL point. A NULL point is DATATYPES.DATUM_NOTEXIST
                if (aeCurExpr.GetDataType() == DATATYPES.DATUM_NOTEXIST)
                    return aeCurExpr;*/
                if (nLastPushedCellType == 1) {
