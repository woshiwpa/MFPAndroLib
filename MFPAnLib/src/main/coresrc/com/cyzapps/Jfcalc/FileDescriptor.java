/*
 * MFP project, FileDescriptor.java : Designed and developed by Tony Cui in 2021
...
public class FileDescriptor {
    ...
    public static class MFPBufferedInputStream {
        ...
        public MFPBufferedInputStream() {}
        
        public MFPBufferedInputStream(FileInputStream fileInputStream) {
    ...
    protected MFPBufferedInputStream mbufferedInputStream = null;
    ...
    public FileDescriptor(int nFileId, String strFileName, String strFilePath, String strFileFullPath, String strFileAbsolutePath, String strFileCanonicalPath,
            BufferedString bufferedString, OutputStreamWriter outputStreamWriter, MFPBufferedInputStream bufferedInputStream, FileOutputStream fileOutputStream) {
        mnFileId = nFileId;
    ...
    public MFPBufferedInputStream getBufferedInputStream() {
