...
public class PolarChartOperator extends com.cyzapps.adapter.PolarChartOperator implements ICreateChart {
	/* create chart */
	@Override
	public MFPChart createChart(ChartCreationParam ccpParam1, Context context) {
        ...
        //flatChart.saveSettings(); not call save calculator_settings here coz coordOrigin and axis len haven't been caclulated.
