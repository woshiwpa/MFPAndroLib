...
public class XYChart extends FlatChart {
	...
	public void updateCoordAxis()	{
		...
		MFPNumeric mfpNumIntTmp = new MFPNumeric((mdXMark1 - mcaXAxis.mdValueFrom)/dXMarkInterval, true).toIntOrNanInfMFPNum();
		double dXMarkStart = mdXMark1 - mfpNumIntTmp.multiply(new MFPNumeric(dXMarkInterval, true)).doubleValue();
		...
		mfpNumIntTmp = new MFPNumeric((mdYMark1 - mcaYAxis.mdValueFrom)/dYMarkInterval, true).toIntOrNanInfMFPNum();
		double dYMarkStart = mdYMark1 - mfpNumIntTmp.multiply(new MFPNumeric(dYMarkInterval, true)).doubleValue();
