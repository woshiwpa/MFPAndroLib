...
public class ActivityConfig3DExprGraph extends Activity {
	...
	public static class AdjOGLExprChartParams implements Serializable	{
		...
		public boolean mbNotShowAxis = true;		
		public boolean mbNotShowTitle = false;		
    ...
    protected void onCreate(Bundle savedInstanceState){
		...
		mchkBoxNotShowAxis.setChecked(adjParams.mbNotShowAxis);
		mchkBoxNotShowTitle.setChecked(adjParams.mbNotShowTitle);
