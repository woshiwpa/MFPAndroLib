package com.cyzapps.GraphDaemon;
...
public class ActivityConfigXYZGraph extends Activity	{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        if (intent != null)	{
        	...
        	mbChartNotShowAxis = intent.getBooleanExtra("NotShowAxis", NOTSHOWAXIS_INITIAL_VALUE);
        	mbChartNotShowTitle = intent.getBooleanExtra("NotShowTitle", NOTSHOWTITLE_INITIAL_VALUE);
        }
		...
		mchkBoxNotShowAxis = (CheckBox) findViewById(R.id.chkBoxNotShowAxis);
		mchkBoxNotShowTitle = (CheckBox) findViewById(R.id.chkBoxNotShowTitle);
		...
		mchkBoxNotShowAxis.setOnCheckedChangeListener(new OnCheckedChangeListener(){
		...
		mchkBoxNotShowTitle.setOnCheckedChangeListener(new OnCheckedChangeListener(){
	...
	private CheckBox mchkBoxNotShowAxis, mchkBoxNotShowTitle;
    ...
    private boolean mbChartNotShowAxis = NOTSHOWAXIS_INITIAL_VALUE;
    private boolean mbNotShowAxis = NOTSHOWAXIS_INITIAL_VALUE;
    private boolean mbChartNotShowTitle = NOTSHOWTITLE_INITIAL_VALUE;
    ...
    public void resetParams()    {
        ...
        mbNotShowAxis = mbChartNotShowAxis;
        mbNotShowTitle = mbChartNotShowTitle;
        ...
        setChartZoomingRatio();
        mchkBoxNotShowAxis.setChecked(mbNotShowAxis);
        mchkBoxNotShowTitle.setChecked(mbNotShowTitle);
    }
    ...
    public AdjOGLChartParams getAdjParams()	{
        ...
        adjParams.mbShowAxisChange = (mbNotShowAxis != mbChartNotShowAxis);
        adjParams.mbShowTitleChange = (mbNotShowTitle != mbChartNotShowTitle);
		return adjParams;
    }
}
